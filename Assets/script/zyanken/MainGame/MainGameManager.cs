...
public class MainGameManager : MonoBehaviour
{
    ...
    EnemyMove eMove;
    public Judge IS_Judge { get { return this.Judge ?? (this.Judge = GetComponent<Judge>()); } }
    Judge Judge;
    ...
    void Update()
    {
        ...
        if (gameMode == GameMode.play)
        {
            ...
            {
                //じゃんけんに勝ったかどうか
                if (IS_Judge.IsJudge(playerMove.SelectPlayerHand,enemyMove.EnemyHand, (int)enemyMove.handColor))
                {
